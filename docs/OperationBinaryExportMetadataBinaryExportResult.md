...
|**metadata** | **BinaryExportMetadata** | In-flight information and details. |  [optional] |
|**name** | **String** | API resource name. |  |
|**response** | **BinaryExportResult** | Result, set only when done is true and the operation succeeded. |  [optional] |
