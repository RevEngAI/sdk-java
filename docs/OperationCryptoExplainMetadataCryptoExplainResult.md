...
|**metadata** | **CryptoExplainMetadata** | In-flight information and details. |  [optional] |
|**name** | **String** | API resource name. |  |
|**response** | **CryptoExplainResult** | Result, set only when done is true and the operation succeeded. |  [optional] |
