...
import ai.reveng.invoker.auth.Authentication;
import ai.reveng.invoker.auth.HttpBasicAuth;
import ai.reveng.invoker.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.reveng.ai";
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.92.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.reveng.ai
     ...
     * @return a {@link ai.reveng.invoker.ApiClient} object
     */
    ...
    */
     ...
     * @throws ai.reveng.invoker.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ai.reveng.invoker.ApiException If fail to serialize the given object
     */
     ...
     * @throws ai.reveng.invoker.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ai.reveng.invoker.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ai.reveng.invoker.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ai.reveng.invoker.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ai.reveng.invoker.ApiException If fails to update the parameters
     */
     ...
     * @throws ai.reveng.invoker.ApiException If fail to serialize the request body object into a string
     */
