...
public class TokenResponse {
  ...
  public TokenResponse expiresIn(@javax.annotation.Nonnull Long expiresIn) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, expiresIn, refreshToken, tokenType, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access_token", "expires_in", "refresh_token", "token_type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("access_token", "expires_in", "refresh_token", "token_type"));
  }
