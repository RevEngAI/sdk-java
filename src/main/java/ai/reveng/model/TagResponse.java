...
public class TagResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, origin, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TagResponse is not found in the empty JSON string", TagResponse.openapiRequiredFields.toString()));
        }
      }
