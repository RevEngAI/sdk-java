...
public class EventDecompFailed {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventDecompFailed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventDecompFailed is not found in the empty JSON string", EventDecompFailed.openapiRequiredFields.toString()));
        }
      }
      ...
      DecompFailedEvent.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<EventDecompFailed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventDecompFailed.class));

       return (TypeAdapter<T>) new TypeAdapter<EventDecompFailed>() {
           @Override
