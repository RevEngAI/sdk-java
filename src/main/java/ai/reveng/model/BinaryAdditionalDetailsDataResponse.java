...
public class BinaryAdditionalDetailsDataResponse {
   ...
   * @return the BinaryAdditionalDetailsDataResponse instance itself
   */
  public BinaryAdditionalDetailsDataResponse putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BinaryAdditionalDetailsDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BinaryAdditionalDetailsDataResponse is not found in the empty JSON string", BinaryAdditionalDetailsDataResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BinaryAdditionalDetailsDataResponse>() {
           ...
           public BinaryAdditionalDetailsDataResponse read(JsonReader in) throws IOException {
             ...
             BinaryAdditionalDetailsDataResponse instance = thisAdapter.fromJsonTree(jsonObj);
