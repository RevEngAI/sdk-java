...
public class MatchedFunctionSuggestion {
  ...
  public MatchedFunctionSuggestion functionId(@javax.annotation.Nonnull Long functionId) {
  ...
  /**
   * Mangled name of the function group that contains the matched functions
   ...
   * @return the MatchedFunctionSuggestion instance itself
   */
  public MatchedFunctionSuggestion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.functionId, matchedFunctionSuggestion.functionId) &&
        ...
        Objects.equals(this.additionalProperties, matchedFunctionSuggestion.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(functionId, functionVaddr, suggestedName, suggestedDemangledName, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchedFunctionSuggestion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MatchedFunctionSuggestion is not found in the empty JSON string", MatchedFunctionSuggestion.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("suggested_demangled_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `suggested_demangled_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("suggested_demangled_name").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MatchedFunctionSuggestion>() {
           ...
           public MatchedFunctionSuggestion read(JsonReader in) throws IOException {
             ...
             MatchedFunctionSuggestion instance = thisAdapter.fromJsonTree(jsonObj);
