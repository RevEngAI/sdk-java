...
public class MatchedFunctionSuggestion {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(functionId, functionVaddr, suggestedDemangledName, suggestedName, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("function_id", "function_vaddr", "suggested_demangled_name", "suggested_name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MatchedFunctionSuggestion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in MatchedFunctionSuggestion is not found in the empty JSON string", MatchedFunctionSuggestion.openapiRequiredFields.toString()));
        }
      }
