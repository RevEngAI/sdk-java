...
public class SecurityModel {
   ...
   * @return the SecurityModel instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecurityModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SecurityModel is not found in the empty JSON string", SecurityModel.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SecurityModel>() {
           ...
           public SecurityModel read(JsonReader in) throws IOException {
             ...
             SecurityModel instance = thisAdapter.fromJsonTree(jsonObj);
