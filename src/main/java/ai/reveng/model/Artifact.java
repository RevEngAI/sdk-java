...
public class Artifact {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(direction, dumpAddr, dumpPid, fileType, host, isPe, mimeType, name, networkSource, originalFilename, path, processSeqid, reason, responseStatus, sha256, size, source, uri, wasMapped, yaraHits, additionalProperties);
  }
