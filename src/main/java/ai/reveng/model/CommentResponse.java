...
public class CommentResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(content, id, userId, resourceType, resourceId, context, createdAt, updatedAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
