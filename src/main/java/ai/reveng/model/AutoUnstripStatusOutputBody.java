...
public class AutoUnstripStatusOutputBody {
   ...
   * @return the AutoUnstripStatusOutputBody instance itself
   */
  public AutoUnstripStatusOutputBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, autoUnstripStatusOutputBody.status)&&
        Objects.equals(this.additionalProperties, autoUnstripStatusOutputBody.additionalProperties);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<AutoUnstripStatusOutputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoUnstripStatusOutputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoUnstripStatusOutputBody>() {
           @Override
           ...
           public AutoUnstripStatusOutputBody read(JsonReader in) throws IOException {
             ...
             AutoUnstripStatusOutputBody instance = thisAdapter.fromJsonTree(jsonObj);
