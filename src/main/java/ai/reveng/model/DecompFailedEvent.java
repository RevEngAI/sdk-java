...
public class DecompFailedEvent {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attempt, error, errorCode, seq, type);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("attempt", "error", "error_code", "seq", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DecompFailedEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DecompFailedEvent is not found in the empty JSON string", DecompFailedEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DecompFailedEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DecompFailedEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<DecompFailedEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DecompFailedEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<DecompFailedEvent>() {
           @Override
