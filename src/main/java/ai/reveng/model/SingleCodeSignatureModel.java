...
public class SingleCodeSignatureModel {
   ...
   * @return the SingleCodeSignatureModel instance itself
   */
  public SingleCodeSignatureModel putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SingleCodeSignatureModel>() {
           ...
           public SingleCodeSignatureModel read(JsonReader in) throws IOException {
             ...
             SingleCodeSignatureModel instance = thisAdapter.fromJsonTree(jsonObj);
