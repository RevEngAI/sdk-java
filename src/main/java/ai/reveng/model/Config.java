...
import ai.reveng.model.SandboxConfig;
...
public class Config {
  ...
  public Config generateCapabilities(@javax.annotation.Nullable Boolean generateCapabilities) {
    this.generateCapabilities = generateCapabilities;
    return this;
  }

  /**
   * Get generateCapabilities
  ...
  public Config noCache(@javax.annotation.Nullable Boolean noCache) {
  ...
  public Config sandboxConfig(@javax.annotation.Nullable SandboxConfig sandboxConfig) {
  ...
  public void setSandboxConfig(@javax.annotation.Nullable SandboxConfig sandboxConfig) {
    this.sandboxConfig = sandboxConfig;
  }


  public Config scrapeThirdPartyConfig(@javax.annotation.Nullable ScrapeThirdPartyConfig scrapeThirdPartyConfig) {
    this.scrapeThirdPartyConfig = scrapeThirdPartyConfig;
    return this;
  }

  /**
   * Get scrapeThirdPartyConfig
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.generateCapabilities, config.generateCapabilities) &&
        Objects.equals(this.noCache, config.noCache) &&
        Objects.equals(this.sandboxConfig, config.sandboxConfig) &&
        Objects.equals(this.scrapeThirdPartyConfig, config.scrapeThirdPartyConfig)&&
        Objects.equals(this.additionalProperties, config.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(generateCapabilities, noCache, sandboxConfig, scrapeThirdPartyConfig, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("generate_capabilities", "no_cache", "sandbox_config", "scrape_third_party_config"));
