...
public class RelativeBinaryResponse {
  ...
  /**
   * ID of the active analysis for this binary
   * @return analysisId
   */
  @javax.annotation.Nullable
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelativeBinaryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RelativeBinaryResponse is not found in the empty JSON string", RelativeBinaryResponse.openapiRequiredFields.toString()));
        }
      }
