...
public class HttpRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bytesReceived, bytesSent, events, extraHeaders, flags, password, path, pcapStreamId, postData, proxy, proxyBypass, referer, requestBody, responseBody, responseStatus, serverIp, serverName, serverPort, service, userAgent, username, verb, version, additionalProperties);
  }
