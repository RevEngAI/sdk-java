  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalysisTags.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AnalysisTags is not found in the empty JSON string", AnalysisTags.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("analysis_tags") != null) {
        if (!jsonObj.get("analysis_tags").isJsonArray()) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `analysis_tags` to be an array in the JSON string but got `%s`", jsonObj.get("analysis_tags").toString()));
        }
