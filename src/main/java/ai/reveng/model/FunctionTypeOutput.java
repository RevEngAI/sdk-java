...
public class FunctionTypeOutput {
   ...
   * @return the FunctionTypeOutput instance itself
   */
  public FunctionTypeOutput putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FunctionTypeOutput>() {
           ...
           public FunctionTypeOutput read(JsonReader in) throws IOException {
             ...
             FunctionTypeOutput instance = thisAdapter.fromJsonTree(jsonObj);
