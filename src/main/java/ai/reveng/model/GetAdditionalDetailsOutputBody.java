...
public class GetAdditionalDetailsOutputBody {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(binaryId, details);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("binary_id", "details"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAdditionalDetailsOutputBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetAdditionalDetailsOutputBody is not found in the empty JSON string", GetAdditionalDetailsOutputBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAdditionalDetailsOutputBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetAdditionalDetailsOutputBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<GetAdditionalDetailsOutputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAdditionalDetailsOutputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAdditionalDetailsOutputBody>() {
           @Override
