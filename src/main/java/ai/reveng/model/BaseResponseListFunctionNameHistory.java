...
public class BaseResponseListFunctionNameHistory {
   ...
   * @return the BaseResponseListFunctionNameHistory instance itself
   */
  public BaseResponseListFunctionNameHistory putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseResponseListFunctionNameHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BaseResponseListFunctionNameHistory is not found in the empty JSON string", BaseResponseListFunctionNameHistory.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BaseResponseListFunctionNameHistory>() {
           ...
           public BaseResponseListFunctionNameHistory read(JsonReader in) throws IOException {
             ...
             BaseResponseListFunctionNameHistory instance = thisAdapter.fromJsonTree(jsonObj);
