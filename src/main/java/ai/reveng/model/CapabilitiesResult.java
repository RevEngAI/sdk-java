...
import ai.reveng.model.Capability;
...
public class CapabilitiesResult {
  ...
  public CapabilitiesResult capabilities(@javax.annotation.Nullable List<Capability> capabilities) {
    this.capabilities = capabilities;
    return this;
  }

  public CapabilitiesResult addCapabilitiesItem(Capability capabilitiesItem) {
   ...
   * @return the CapabilitiesResult instance itself
   */
  public CapabilitiesResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.capabilities, capabilitiesResult.capabilities)&&
        Objects.equals(this.additionalProperties, capabilitiesResult.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapabilitiesResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CapabilitiesResult is not found in the empty JSON string", CapabilitiesResult.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CapabilitiesResult.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CapabilitiesResult>() {
           ...
           public CapabilitiesResult read(JsonReader in) throws IOException {
             ...
             CapabilitiesResult instance = thisAdapter.fromJsonTree(jsonObj);
