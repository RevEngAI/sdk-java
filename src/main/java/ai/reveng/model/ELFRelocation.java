...
public class ELFRelocation {
   ...
   * @return the ELFRelocation instance itself
   */
  public ELFRelocation putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ELFRelocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ELFRelocation is not found in the empty JSON string", ELFRelocation.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("symbol_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `symbol_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("symbol_name").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ELFRelocation>() {
           ...
           public ELFRelocation read(JsonReader in) throws IOException {
             ...
             ELFRelocation instance = thisAdapter.fromJsonTree(jsonObj);
