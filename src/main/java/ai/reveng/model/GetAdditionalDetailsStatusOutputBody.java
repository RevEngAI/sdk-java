...
public class GetAdditionalDetailsStatusOutputBody {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAdditionalDetailsStatusOutputBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetAdditionalDetailsStatusOutputBody is not found in the empty JSON string", GetAdditionalDetailsStatusOutputBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAdditionalDetailsStatusOutputBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetAdditionalDetailsStatusOutputBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<GetAdditionalDetailsStatusOutputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAdditionalDetailsStatusOutputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAdditionalDetailsStatusOutputBody>() {
           @Override
