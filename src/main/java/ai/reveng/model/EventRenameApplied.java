...
public class EventRenameApplied {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventRenameApplied.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventRenameApplied is not found in the empty JSON string", EventRenameApplied.openapiRequiredFields.toString()));
        }
      }
      ...
      RenameAppliedEvent.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<EventRenameApplied> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventRenameApplied.class));

       return (TypeAdapter<T>) new TypeAdapter<EventRenameApplied>() {
           @Override
