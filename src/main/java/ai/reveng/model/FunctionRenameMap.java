...
public class FunctionRenameMap {
   ...
   * @return the FunctionRenameMap instance itself
   */
  public FunctionRenameMap putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FunctionRenameMap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FunctionRenameMap is not found in the empty JSON string", FunctionRenameMap.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FunctionRenameMap>() {
           ...
           public FunctionRenameMap read(JsonReader in) throws IOException {
             ...
             FunctionRenameMap instance = thisAdapter.fromJsonTree(jsonObj);
