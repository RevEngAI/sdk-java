...
public class AutoUnstripRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(minSimilarity, apply, confidenceThreshold, minGroupSize);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoUnstripRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoUnstripRequest is not found in the empty JSON string", AutoUnstripRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoUnstripRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoUnstripRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
