...
public class AddTeamMemberInputBody {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("user_id"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<AddTeamMemberInputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddTeamMemberInputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<AddTeamMemberInputBody>() {
           @Override
