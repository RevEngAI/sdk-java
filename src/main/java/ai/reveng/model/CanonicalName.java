...
public class CanonicalName {
   ...
   * @return the CanonicalName instance itself
   */
  public CanonicalName putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.canonicalName, canonicalName.canonicalName) &&
        ...
        Objects.equals(this.additionalProperties, canonicalName.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(canonicalName, name, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("canonical_name", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("canonical_name", "name"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CanonicalName> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CanonicalName.class));

       return (TypeAdapter<T>) new TypeAdapter<CanonicalName>() {
           @Override
           ...
           public CanonicalName read(JsonReader in) throws IOException {
             ...
             CanonicalName instance = thisAdapter.fromJsonTree(jsonObj);
