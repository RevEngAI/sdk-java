...
public class QueuePositionResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.$schema, queuePositionResponse.$schema) &&
        Objects.equals(this.queuePosition, queuePositionResponse.queuePosition)&&
        Objects.equals(this.additionalProperties, queuePositionResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash($schema, queuePosition, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("$schema", "queue_position"));
