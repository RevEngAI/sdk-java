...
public class TimestampModel {
   ...
   * @return the TimestampModel instance itself
   */
  public TimestampModel putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimestampModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TimestampModel is not found in the empty JSON string", TimestampModel.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TimestampModel>() {
           ...
           public TimestampModel read(JsonReader in) throws IOException {
             ...
             TimestampModel instance = thisAdapter.fromJsonTree(jsonObj);
