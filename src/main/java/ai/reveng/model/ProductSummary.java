...
public class ProductSummary {
  ...
  public ProductSummary name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the ProductSummary instance itself
   */
  public ProductSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, productSummary.name)&&
        Objects.equals(this.additionalProperties, productSummary.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProductSummary is not found in the empty JSON string", ProductSummary.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductSummary.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductSummary>() {
           ...
           public ProductSummary read(JsonReader in) throws IOException {
             ...
             ProductSummary instance = thisAdapter.fromJsonTree(jsonObj);
