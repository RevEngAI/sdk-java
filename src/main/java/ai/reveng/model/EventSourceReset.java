...
public class EventSourceReset {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventSourceReset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventSourceReset is not found in the empty JSON string", EventSourceReset.openapiRequiredFields.toString()));
        }
      }
      ...
      SourceResetEvent.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<EventSourceReset> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventSourceReset.class));

       return (TypeAdapter<T>) new TypeAdapter<EventSourceReset>() {
           @Override
