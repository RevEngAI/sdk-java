...
public class RenameInputBody {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RenameInputBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RenameInputBody is not found in the empty JSON string", RenameInputBody.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<RenameInputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RenameInputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<RenameInputBody>() {
           @Override
