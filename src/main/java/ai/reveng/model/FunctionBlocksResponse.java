...
public class FunctionBlocksResponse {
   ...
   * @return the FunctionBlocksResponse instance itself
   */
  public FunctionBlocksResponse putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FunctionBlocksResponse>() {
           ...
           public FunctionBlocksResponse read(JsonReader in) throws IOException {
             ...
             FunctionBlocksResponse instance = thisAdapter.fromJsonTree(jsonObj);
