...
public class Logs {
   ...
   * @return the Logs instance itself
   */
  public Logs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logs, logs.logs)&&
        Objects.equals(this.additionalProperties, logs.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Logs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Logs is not found in the empty JSON string", Logs.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("logs").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `logs` to be a primitive type in the JSON string but got `%s`", jsonObj.get("logs").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Logs>() {
           ...
           public Logs read(JsonReader in) throws IOException {
             ...
             Logs instance = thisAdapter.fromJsonTree(jsonObj);
