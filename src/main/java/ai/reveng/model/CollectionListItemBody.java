...
public class CollectionListItemBody {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(collectionId, collectionName, collectionOwner, collectionScope, collectionSize, collectionTags, creation, description, officialCollection, teamId, updatedAt, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionListItemBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CollectionListItemBody is not found in the empty JSON string", CollectionListItemBody.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("collection_owner").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `collection_owner` to be a primitive type in the JSON string but got `%s`", jsonObj.get("collection_owner").toString()));
      }
      ...
      } else if (!jsonObj.get("collection_tags").isJsonArray() && !jsonObj.get("collection_tags").isJsonNull()) {
