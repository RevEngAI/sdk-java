...
public class IndirectCallSitesOutputBody {
   ...
   * @return the IndirectCallSitesOutputBody instance itself
   */
  public IndirectCallSitesOutputBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.functionId, indirectCallSitesOutputBody.functionId) &&
        ...
        Objects.equals(this.additionalProperties, indirectCallSitesOutputBody.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(functionId, sites, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("sites") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("sites").isJsonArray() && !jsonObj.get("sites").isJsonNull()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IndirectCallSitesOutputBody>() {
           ...
           public IndirectCallSitesOutputBody read(JsonReader in) throws IOException {
             ...
             IndirectCallSitesOutputBody instance = thisAdapter.fromJsonTree(jsonObj);
