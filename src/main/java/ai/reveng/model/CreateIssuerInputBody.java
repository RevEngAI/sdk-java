...
public class CreateIssuerInputBody {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("client_id", "issuer_url"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("issuer_url"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreateIssuerInputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIssuerInputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIssuerInputBody>() {
           @Override
