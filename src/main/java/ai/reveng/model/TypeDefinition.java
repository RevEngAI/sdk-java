...
public class TypeDefinition {
   ...
   * @return the TypeDefinition instance itself
   */
  public TypeDefinition putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TypeDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TypeDefinition is not found in the empty JSON string", TypeDefinition.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TypeDefinition>() {
           ...
           public TypeDefinition read(JsonReader in) throws IOException {
             ...
             TypeDefinition instance = thisAdapter.fromJsonTree(jsonObj);
