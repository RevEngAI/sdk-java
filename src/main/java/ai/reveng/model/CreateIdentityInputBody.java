...
public class CreateIdentityInputBody {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("issuer_url", "subject", "user_id"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("issuer_url", "subject", "user_id"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<CreateIdentityInputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIdentityInputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIdentityInputBody>() {
           @Override
