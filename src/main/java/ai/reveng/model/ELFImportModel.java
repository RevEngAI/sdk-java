...
public class ELFImportModel {
   ...
   * @return the ELFImportModel instance itself
   */
  public ELFImportModel putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ELFImportModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ELFImportModel is not found in the empty JSON string", ELFImportModel.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ELFImportModel>() {
           ...
           public ELFImportModel read(JsonReader in) throws IOException {
             ...
             ELFImportModel instance = thisAdapter.fromJsonTree(jsonObj);
