...
public class FunctionDetailsOutputBody {
   ...
   * @return the FunctionDetailsOutputBody instance itself
   */
  public FunctionDetailsOutputBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.analysisId, functionDetailsOutputBody.analysisId) &&
        ...
        Objects.equals(this.additionalProperties, functionDetailsOutputBody.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(analysisId, binaryId, creation, debug, functionId, functionName, functionSize, functionVaddr, mangledName, sourceFunctionId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FunctionDetailsOutputBody>() {
           ...
           public FunctionDetailsOutputBody read(JsonReader in) throws IOException {
             ...
             FunctionDetailsOutputBody instance = thisAdapter.fromJsonTree(jsonObj);
