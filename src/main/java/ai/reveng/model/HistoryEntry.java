...
public class HistoryEntry {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(changeMadeBy, createdAt, functionName, historyId, isDebug, mangledName, sourceAnalysisId, sourceFunctionId, sourceType, additionalProperties);
  }
