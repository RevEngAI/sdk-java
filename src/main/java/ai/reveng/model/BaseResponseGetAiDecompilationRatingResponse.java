...
import ai.reveng.model.GetAiDecompilationRatingResponse;
...
public class BaseResponseGetAiDecompilationRatingResponse {
  ...
  @javax.annotation.Nullable
  private GetAiDecompilationRatingResponse data;
   ...
   */
  @javax.annotation.Nullable
  public GetAiDecompilationRatingResponse getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable GetAiDecompilationRatingResponse data) {
    this.data = data;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseResponseGetAiDecompilationRatingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseResponseGetAiDecompilationRatingResponse is not found in the empty JSON string", BaseResponseGetAiDecompilationRatingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BaseResponseGetAiDecompilationRatingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BaseResponseGetAiDecompilationRatingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        GetAiDecompilationRatingResponse.validateJsonElement(jsonObj.get("data"));
      }
