...
public class NetworkOverviewMetadata {
   ...
   * @return the NetworkOverviewMetadata instance itself
   */
  public NetworkOverviewMetadata putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NetworkOverviewMetadata>() {
           ...
           public NetworkOverviewMetadata read(JsonReader in) throws IOException {
             ...
             NetworkOverviewMetadata instance = thisAdapter.fromJsonTree(jsonObj);
