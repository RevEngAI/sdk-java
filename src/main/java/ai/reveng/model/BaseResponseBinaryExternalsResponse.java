...
public class BaseResponseBinaryExternalsResponse {
   ...
   * @return the BaseResponseBinaryExternalsResponse instance itself
   */
  public BaseResponseBinaryExternalsResponse putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseResponseBinaryExternalsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BaseResponseBinaryExternalsResponse is not found in the empty JSON string", BaseResponseBinaryExternalsResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BaseResponseBinaryExternalsResponse>() {
           ...
           public BaseResponseBinaryExternalsResponse read(JsonReader in) throws IOException {
             ...
             BaseResponseBinaryExternalsResponse instance = thisAdapter.fromJsonTree(jsonObj);
