...
public class TriggerDynamicExecutionInputBody {
  ...
  public TriggerDynamicExecutionInputBody startMethod(@javax.annotation.Nullable StartMethodEnum startMethod) {
  ...
  public TriggerDynamicExecutionInputBody timeout(@javax.annotation.Nullable TimeoutEnum timeout) {
   ...
   * @return the TriggerDynamicExecutionInputBody instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to TriggerDynamicExecutionInputBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TriggerDynamicExecutionInputBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TriggerDynamicExecutionInputBody is not found in the empty JSON string", TriggerDynamicExecutionInputBody.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TriggerDynamicExecutionInputBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TriggerDynamicExecutionInputBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TriggerDynamicExecutionInputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TriggerDynamicExecutionInputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<TriggerDynamicExecutionInputBody>() {
           @Override
           public void write(JsonWriter out, TriggerDynamicExecutionInputBody value) throws IOException {
           ...
           @Override
           public TriggerDynamicExecutionInputBody read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TriggerDynamicExecutionInputBody instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @return An instance of TriggerDynamicExecutionInputBody
   * @throws IOException if the JSON string is invalid with respect to TriggerDynamicExecutionInputBody
   */
  public static TriggerDynamicExecutionInputBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TriggerDynamicExecutionInputBody.class);
  }
