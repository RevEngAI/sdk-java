...
public class Connection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bytesReceived, bytesSent, events, ja3, ja3s, localIp, localPort, protocol, remoteIp, remotePort, tcpCarvedFiles, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("tcp_carved_files") != null && !jsonObj.get("tcp_carved_files").isJsonNull() && !jsonObj.get("tcp_carved_files").isJsonArray()) {
