...
public class PaginationModel {
   ...
   * @return the PaginationModel instance itself
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaginationModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PaginationModel is not found in the empty JSON string", PaginationModel.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PaginationModel>() {
           ...
           public PaginationModel read(JsonReader in) throws IOException {
             ...
             PaginationModel instance = thisAdapter.fromJsonTree(jsonObj);
