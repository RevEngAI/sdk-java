...
public class BaseResponse {
  ...
  public BaseResponse data(@javax.annotation.Nullable AnyOf data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AnyOf getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable AnyOf data) {
    this.data = data;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        AnyOf.validateJsonElement(jsonObj.get("data"));
      }
