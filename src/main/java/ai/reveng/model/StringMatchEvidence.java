...
public class StringMatchEvidence {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(evidenceKind, kind, effect, strength, strings, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("evidence_kind", "kind", "effect", "strength", "strings"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("effect", "strings"));
  }
