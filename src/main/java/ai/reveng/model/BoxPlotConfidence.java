...
public class BoxPlotConfidence {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(min, max, average, upperQuartile, lowerQuartile, positiveCount, negativeCount);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoxPlotConfidence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoxPlotConfidence is not found in the empty JSON string", BoxPlotConfidence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoxPlotConfidence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoxPlotConfidence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
