...
public class EventDecompFinished {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventDecompFinished.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventDecompFinished is not found in the empty JSON string", EventDecompFinished.openapiRequiredFields.toString()));
        }
      }
      ...
      DecompFinishedEvent.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<EventDecompFinished> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventDecompFinished.class));

       return (TypeAdapter<T>) new TypeAdapter<EventDecompFinished>() {
           @Override
