...
public class StackVariable {
  ...
  /**
   * Timestamp of the last change to this stack variable
   * @return lastChange
   */
  @javax.annotation.Nullable
   ...
   * @return the StackVariable instance itself
   */
  public StackVariable putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackVariable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StackVariable is not found in the empty JSON string", StackVariable.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StackVariable>() {
           ...
           public StackVariable read(JsonReader in) throws IOException {
             ...
             StackVariable instance = thisAdapter.fromJsonTree(jsonObj);
