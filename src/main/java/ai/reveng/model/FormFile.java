...
public class FormFile {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ContentType", "Filename", "IsSet", "Size"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("ContentType", "Filename", "IsSet", "Size"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<FormFile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormFile.class));

       return (TypeAdapter<T>) new TypeAdapter<FormFile>() {
           @Override
