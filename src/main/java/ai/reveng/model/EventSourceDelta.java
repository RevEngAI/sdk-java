...
public class EventSourceDelta {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventSourceDelta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventSourceDelta is not found in the empty JSON string", EventSourceDelta.openapiRequiredFields.toString()));
        }
      }
      ...
      SourceDeltaEvent.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<EventSourceDelta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventSourceDelta.class));

       return (TypeAdapter<T>) new TypeAdapter<EventSourceDelta>() {
           @Override
