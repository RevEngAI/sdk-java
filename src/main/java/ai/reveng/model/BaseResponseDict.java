...
public class BaseResponseDict {
   ...
   * @return the BaseResponseDict instance itself
   */
  public BaseResponseDict putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseResponseDict.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BaseResponseDict is not found in the empty JSON string", BaseResponseDict.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BaseResponseDict>() {
           ...
           public BaseResponseDict read(JsonReader in) throws IOException {
             ...
             BaseResponseDict instance = thisAdapter.fromJsonTree(jsonObj);
