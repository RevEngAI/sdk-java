...
public class Capability {
  ...
  public Capability capability(@javax.annotation.Nonnull String capability) {
  ...
  public Capability description(@javax.annotation.Nonnull String description) {
  ...
  public Capability functionId(@javax.annotation.Nonnull Long functionId) {
  ...
  public Capability functionVaddr(@javax.annotation.Nonnull String functionVaddr) {
  ...
  public Capability type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.capability, capability.capability) &&
        Objects.equals(this.description, capability.description) &&
        Objects.equals(this.functionId, capability.functionId) &&
        Objects.equals(this.functionName, capability.functionName) &&
        Objects.equals(this.functionVaddr, capability.functionVaddr) &&
        Objects.equals(this.type, capability.type)&&
        Objects.equals(this.additionalProperties, capability.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(capability, description, functionId, functionName, functionVaddr, type, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("capability", "description", "function_id", "function_name", "function_vaddr", "type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("capability", "description", "function_id", "function_name", "function_vaddr", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Capability.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Capability is not found in the empty JSON string", Capability.openapiRequiredFields.toString()));
        }
      }
