...
public class Status {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, detail, docUrl, message);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "detail", "doc_url", "message"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("code", "doc_url", "message"));
  }
