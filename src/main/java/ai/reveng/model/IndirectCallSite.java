...
public class IndirectCallSite {
   ...
   * @return the IndirectCallSite instance itself
   */
  public IndirectCallSite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.calleeFunctionId, indirectCallSite.calleeFunctionId) &&
        ...
        Objects.equals(this.additionalProperties, indirectCallSite.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(calleeFunctionId, instVaddr, isExternal, targetName, targetVaddr, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IndirectCallSite>() {
           ...
           public IndirectCallSite read(JsonReader in) throws IOException {
             ...
             IndirectCallSite instance = thisAdapter.fromJsonTree(jsonObj);
