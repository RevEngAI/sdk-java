...
public class SectionModel {
  public static final String SERIALIZED_NAME_NUMBER_OF_SECTIONS = "number_of_sections";
  @SerializedName(SERIALIZED_NAME_NUMBER_OF_SECTIONS)
  ...
  @javax.annotation.Nonnull
  private List<SingleSectionModel> sections = new ArrayList<>();

  public SectionModel() {
  }

  public SectionModel numberOfSections(@javax.annotation.Nonnull Integer numberOfSections) {
  ...
  public void setNumberOfSections(@javax.annotation.Nonnull Integer numberOfSections) {
    this.numberOfSections = numberOfSections;
  }


  public SectionModel sections(@javax.annotation.Nonnull List<SingleSectionModel> sections) {
    this.sections = sections;
    return this;
  }

  public SectionModel addSectionsItem(SingleSectionModel sectionsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<SingleSectionModel> getSections() {
    return sections;
  }

  public void setSections(@javax.annotation.Nonnull List<SingleSectionModel> sections) {
    this.sections = sections;
  }
   ...
   * @return the SectionModel instance itself
   */
  public SectionModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.numberOfSections, sectionModel.numberOfSections) &&
        Objects.equals(this.sections, sectionModel.sections)&&
        Objects.equals(this.additionalProperties, sectionModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numberOfSections, sections, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("number_of_sections", "sections"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("number_of_sections", "sections"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SectionModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SectionModel is not found in the empty JSON string", SectionModel.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("sections") != null) {
        ...
        for (int i = 0; i < jsonArraysections.size(); i++) {
          SingleSectionModel.validateJsonElement(jsonArraysections.get(i));
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SectionModel>() {
           ...
           public SectionModel read(JsonReader in) throws IOException {
             ...
             SectionModel instance = thisAdapter.fromJsonTree(jsonObj);
