...
public class TeamMember {
  ...
  public TeamMember isAdmin(@javax.annotation.Nonnull Boolean isAdmin) {
  ...
  public TeamMember role(@javax.annotation.Nonnull RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public TeamMember userId(@javax.annotation.Nonnull Long userId) {
    this.userId = userId;
    return this;
  }
   ...
   * @return the TeamMember instance itself
   */
  public TeamMember putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, teamMember.email) &&
        Objects.equals(this.isAdmin, teamMember.isAdmin) &&
        ...
        Objects.equals(this.additionalProperties, teamMember.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, isAdmin, role, userId, username, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("email", "is_admin", "role", "user_id", "username"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("email", "is_admin", "role", "user_id", "username"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TeamMember>() {
           ...
           public TeamMember read(JsonReader in) throws IOException {
             ...
             TeamMember instance = thisAdapter.fromJsonTree(jsonObj);
