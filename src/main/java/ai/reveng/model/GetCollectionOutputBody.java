...
public class GetCollectionOutputBody {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(binaries, collectionId, collectionName, collectionScope, createdAt, description, hasNextPage, modelId, pageNumber, pageSize, tags, teamId, updatedAt, userId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCollectionOutputBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetCollectionOutputBody is not found in the empty JSON string", GetCollectionOutputBody.openapiRequiredFields.toString()));
        }
      }
