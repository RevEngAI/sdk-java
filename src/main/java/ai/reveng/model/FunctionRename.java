...
public class FunctionRename {
   ...
   * @return the FunctionRename instance itself
   */
  public FunctionRename putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FunctionRename.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FunctionRename is not found in the empty JSON string", FunctionRename.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FunctionRename>() {
           ...
           public FunctionRename read(JsonReader in) throws IOException {
             ...
             FunctionRename instance = thisAdapter.fromJsonTree(jsonObj);
