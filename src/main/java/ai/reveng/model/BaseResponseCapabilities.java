...
public class BaseResponseCapabilities {
   ...
   * @return the BaseResponseCapabilities instance itself
   */
  public BaseResponseCapabilities putAdditionalProperty(String key, Object value) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseResponseCapabilities.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BaseResponseCapabilities is not found in the empty JSON string", BaseResponseCapabilities.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BaseResponseCapabilities>() {
           ...
           public BaseResponseCapabilities read(JsonReader in) throws IOException {
             ...
             BaseResponseCapabilities instance = thisAdapter.fromJsonTree(jsonObj);
