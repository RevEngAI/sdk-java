...
public class FunctionMappingFull {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(inverseStringMap, inverseFunctionMap, unmatchedFunctions, unmatchedExternalVars, unmatchedCustomTypes, unmatchedStrings, unmatchedVars, unmatchedGoToLabels, unmatchedCustomFunctionPointers, unmatchedVariadicLists, fields);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FunctionMappingFull.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FunctionMappingFull is not found in the empty JSON string", FunctionMappingFull.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FunctionMappingFull.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FunctionMappingFull` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
