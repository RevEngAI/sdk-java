...
public class DebugPromptEvent {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("activity", "attempt", "seq", "type", "user_prompt"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("activity", "attempt", "seq", "type", "user_prompt"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<DebugPromptEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DebugPromptEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<DebugPromptEvent>() {
           @Override
