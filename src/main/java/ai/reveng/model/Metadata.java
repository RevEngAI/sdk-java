...
public class Metadata {
  ...
  public Metadata logHistory(@javax.annotation.Nullable List<List<Object>> logHistory) {
    this.logHistory = logHistory;
    return this;
  }

  public Metadata addLogHistoryItem(List<Object> logHistoryItem) {
  ...
  public Metadata status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logHistory, metadata.logHistory) &&
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("log_history", "status"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("log_history") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("log_history").isJsonArray() && !jsonObj.get("log_history").isJsonNull()) {
