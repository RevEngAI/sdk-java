  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SingleSectionModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SingleSectionModel is not found in the empty JSON string", SingleSectionModel.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("characteristics").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `characteristics` to be a primitive type in the JSON string but got `%s`", jsonObj.get("characteristics").toString()));
      }
