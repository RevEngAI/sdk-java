...
public class Enumeration {
  ...
  /**
   * Timestamp of the last change to this enumeration
   * @return lastChange
   */
  @javax.annotation.Nullable
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Enumeration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Enumeration is not found in the empty JSON string", Enumeration.openapiRequiredFields.toString()));
        }
      }
