...
public class ReportResult {
  ...
  public ReportResult findings(@javax.annotation.Nullable Object findings) {
  ...
  public ReportResult meta(@javax.annotation.Nullable Object meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.findings, reportResult.findings) &&
        Objects.equals(this.meta, reportResult.meta)&&
        Objects.equals(this.additionalProperties, reportResult.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(findings, meta, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("findings", "meta"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("findings", "meta"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReportResult is not found in the empty JSON string", ReportResult.openapiRequiredFields.toString()));
        }
      }
