...
public class EventProse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventProse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventProse is not found in the empty JSON string", EventProse.openapiRequiredFields.toString()));
        }
      }
      ...
      ProseEvent.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<EventProse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventProse.class));

       return (TypeAdapter<T>) new TypeAdapter<EventProse>() {
           @Override
