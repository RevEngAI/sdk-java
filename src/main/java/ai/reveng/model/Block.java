...
public class Block {
  ...
  public Block virtualAddress(@javax.annotation.Nonnull Integer virtualAddress) {
  ...
  public boolean equals(Object o) {
    ...
    Block block = (Block) o;
    return Objects.equals(this.virtualAddress, block.virtualAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(virtualAddress);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("virtual_address"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("virtual_address"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Block.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Block is not found in the empty JSON string", Block.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Block.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Block` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
