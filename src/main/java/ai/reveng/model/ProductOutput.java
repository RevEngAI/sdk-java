...
public class ProductOutput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creditsPerMonth, description, features, id, name, prices, salesOnly, tier, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("prices") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("prices").isJsonArray() && !jsonObj.get("prices").isJsonNull()) {
