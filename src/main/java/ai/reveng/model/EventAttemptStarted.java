...
public class EventAttemptStarted {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventAttemptStarted.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventAttemptStarted is not found in the empty JSON string", EventAttemptStarted.openapiRequiredFields.toString()));
        }
      }
      ...
      AttemptStartedEvent.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<EventAttemptStarted> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventAttemptStarted.class));

       return (TypeAdapter<T>) new TypeAdapter<EventAttemptStarted>() {
           @Override
