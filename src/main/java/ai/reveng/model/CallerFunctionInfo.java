  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CallerFunctionInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CallerFunctionInfo is not found in the empty JSON string", CallerFunctionInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("caller_vaddr").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `caller_vaddr` to be a primitive type in the JSON string but got `%s`", jsonObj.get("caller_vaddr").toString()));
      }
  }
