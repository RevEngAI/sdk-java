...
public class ELFSymbol {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, value, size, type, binding, visibility, sectionIndex);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ELFSymbol.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ELFSymbol is not found in the empty JSON string", ELFSymbol.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ELFSymbol.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ELFSymbol` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
