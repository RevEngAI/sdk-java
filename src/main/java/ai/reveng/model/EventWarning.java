...
public class EventWarning {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventWarning
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventWarning.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventWarning is not found in the empty JSON string", EventWarning.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventWarning.openapiRequiredFields) {
      ...
      WarningEvent.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventWarning.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventWarning' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventWarning> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventWarning.class));

       return (TypeAdapter<T>) new TypeAdapter<EventWarning>() {
           @Override
           public void write(JsonWriter out, EventWarning value) throws IOException {
           ...
           @Override
           public EventWarning read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EventWarning instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EventWarning given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventWarning
   * @throws IOException if the JSON string is invalid with respect to EventWarning
   */
  public static EventWarning fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventWarning.class);
  }

  /**
   * Convert an instance of EventWarning to an JSON string
   *
   * @return JSON string
   */
